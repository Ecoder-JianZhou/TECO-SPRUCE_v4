...
!            write(662,*)'sdoy, GPP_d, NEE_d, Reco_d, NPP_d, Ra_d, QC1, QC2, QC3, add, storage, LAIMAX, Rh_d, LAI, Tleaf(1)'
        ...
        ! end of inserting
                            ...
                            write (70,*)'day,CH4emit_d,watertable,swc1,swc2,swc3,stsurf,st1,st2'
...
!        Tveg=14.5
    ...
    elseif (do_co2_fcast) then
        ...
        write(62,*)'sdoy,GPP_d,NEE_d,Reco_d,QC(1),QC(6),QC(2),QC(7),&
           ...
           outfile=adjustl(outfile)
           open(70,file=outfile)
        write (70,*)'isimu,CH4emit_d,watertable,swc1,swc2,swc3,stsurf,st1,st2'
!
...
! .. int add more ouput files
                        ...
                        ! outfile=adjustl(outfile)
                        ! open(70,file=outfile)
                        ! write (70,*)'isimu,CH4emit_d,watertable,wcl1,wcl2,wcl3,stsurf,st1,st2'
                        ! do i=1,daily
                            ! write(70,700)i,Simu_dailyCH4(1,i),Simu_dailywatertable(1,i), &
                            ! &   (Simu_dailywater(j,i),j=11,13),(Simu_dailysoilt(j,i),j=1,3)
                        ! enddo
